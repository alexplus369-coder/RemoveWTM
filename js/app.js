// app.js
// Lógica de la interfaz de usuario, eventos y manejo de archivos.
...
(async () => {
  try {
    ...
    statusText.textContent = 'Listo · mapas de calibración cargados ✓';
  } catch (err) {
    statusDot.className = 'w-2.5 h-2.5 rounded-full bg-red-500';
    statusText.textContent = 'Error al cargar mapas. Verifica assets/';
    console.error(err);
  }
})();
